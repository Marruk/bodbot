...
export function riderNameToPcsUrl(name: string): string {
  const sanitizedRider = removeDiacritics(name)
  ...
  return 'rider/' + firstName.toLowerCase().replaceAll(' ', '-') + '-' + lastName.toLowerCase().replaceAll(' ', '-')
}
